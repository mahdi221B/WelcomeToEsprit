...
public class AvailablityController {
    ...
    public AvailablityDay createAvailablityDay(@RequestBody AvailablityDay availablityDay, @PathVariable("id") Integer id) {
        return availablity.createAvailablityDay(availablityDay,id);
    }

    @GetMapping("/getUserDisponbility/{id}")
    @ResponseBody
    public List<AvailablityDay> getUserDisponbility(@PathVariable("id") Integer id) {
