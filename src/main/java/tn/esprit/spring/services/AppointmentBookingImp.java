...
*/
    ...
    public void sendConfirmationEmail(AppointmentBooking appointment , Integer id ) {
    ...
    public List<String> getSortedAppointmentsWithTeachers() {
        ...
        for (AppointmentBooking appointment : appointments) {
            ...
            if (bestTeacher != null) {
                String appointmentInfo = "Candidat : " + appointment.getUser().getFirstName() + ", Teacher : " + bestTeacher.getFirstName() + ", Date de rendez-vous : " + appointment.getDate_reservation();
